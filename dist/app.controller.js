...
const skipAuth_decorator_1 = require("./decorators/skipAuth.decorator");
...
let AppController = exports.AppController = class AppController {
    ...
    async login(body) {
        try {
            ...
            throw new common_1.InternalServerErrorException("An error has occured", error);
        }
    }
};
__decorate([
    (0, skipAuth_decorator_1.SkipAuth)(),
